...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    hero: {
      ...
      description: 'Premium Shopify theme development and expert e-commerce solutions for ambitious brands.',
      cta: 'Start Your Project',
      ctaSecondary: 'View Our Work',
    },
    // Footer
    footer: {
      description: 'Premium Shopify theme development agency creating exceptional e-commerce experiences that drive results and exceed expectations.',
      resources: 'Resources',
  ...
  es: {
    ...
    hero: {
      ...
      description: 'Desarrollo premium de temas de Shopify y soluciones de comercio electrónico experto para marcas ambiciosas.',
      cta: 'Comienza tu proyecto',
      ctaSecondary: 'Ver nuestro trabajo',
    },
    footer: {
      description: 'Agencia premium de desarrollo de temas de Shopify que crea experiencias excepcionales de comercio electrónico que generan resultados y superan expectativas.',
      resources: 'Recursos',
  ...
  fr: {
    ...
    hero: {
      ...
      description: 'Développement premium de thèmes Shopify et solutions de commerce électronique expertes pour les marques ambitieuses.',
      cta: 'Commencez votre projet',
      ctaSecondary: 'Voir nos travaux',
    },
    footer: {
      description: 'Agence de développement premium de thèmes Shopify créant des expériences de commerce électronique exceptionnelles qui produisent des résultats et dépassent les attentes.',
  ...
  de: {
    ...
    hero: {
      ...
      description: 'Premium-Shopify-Theme-Entwicklung und E-Commerce-Lösungen für ehrgeizige Marken.',
      cta: 'Starten Sie Ihr Projekt',
      ctaSecondary: 'Unsere Arbeiten anzeigen',
    },
    footer: {
      description: 'Premium-Agentur für Shopify-Theme-Entwicklung, die außergewöhnliche E-Commerce-Erfahrungen schafft, die Ergebnisse bringen und Erwartungen übertreffen.',
  ...
  it: {
    ...
    hero: {
      ...
      description: 'Sviluppo premium di temi Shopify e soluzioni di e-commerce esperte per brand ambiziosi.',
      cta: 'Inizia il tuo progetto',
      ctaSecondary: 'Visualizza i nostri lavori',
    },
    footer: {
      description: 'Agenzia premium di sviluppo di temi Shopify che crea esperienze di e-commerce eccezionali che producono risultati e superano le aspettative.',
      resources: 'Risorse',
  ...
  pt: {
    ...
    hero: {
      ...
      description: 'Desenvolvimento premium de temas Shopify e soluções de e-commerce especializada para marcas ambiciosas.',
      cta: 'Comece seu projeto',
      ctaSecondary: 'Ver nossos trabalhos',
    },
    footer: {
      description: 'Agência premium de desenvolvimento de temas Shopify criando experiências de e-commerce excepcionais que geram resultados e excedem expectativas.',
      resources: 'Recursos',
  ...
  zh: {
    ...
    hero: {
      ...
      description: '为雄心勃勃的品牌提供高级 Shopify 主题开发和专业电子商务解决方案。',
      cta: '开始您的项目',
      ctaSecondary: '查看我们的作品',
    },
    footer: {
      description: '高级 Shopify 主题开发机构，创建卓越的电子商务体验，产生结果并超越期望。',
      resources: '资源',
      documentation: '文档',
      support: '支持',
      faq: '常见问题',
  ...
  ja: {
    ...
    hero: {
      ...
      description: '野心的なブランドのための高級 Shopify テーマ開発と専門的な e コマース ソリューション。',
      cta: 'プロジェクトを開始',
      ctaSecondary: '制作事例を見る',
    },
    footer: {
      description: '優れた e コマース体験を生み出し、成果を上げ、期待を超える高級 Shopify テーマ開発機関。',
      resources: 'リソース',
  ...
  ar: {
    ...
    hero: {
      ...
      description: 'تطوير متقدم لمواضيع Shopify وحلول التجارة الإلكترونية المتخصصة للعلامات الطموحة.',
      cta: 'ابدأ مشروعك',
      ctaSecondary: 'عرض أعمالنا',
    },
    footer: {
      description: 'وكالة متقدمة لتطوير مواضيع Shopify تنشئ تجارب التجارة الإلكترونية الاستثنائية التي تحقق النتائج وتتجاوز التوقعات.',
      resources: 'الموارد',
  ...
  ru: {
    ...
    hero: {
      ...
      description: 'Премиальная разработка тем Shopify и экспертные решения электронной коммерции для амбициозных брендов.',
      cta: 'Начните свой проект',
      ctaSecondary: 'Посмотреть наши работы',
    },
    footer: {
      description: 'Премиальное агентство по разработке тем Shopify, создающее исключительные впечатления электронной коммерции, которые приносят результаты и превосходят ожидания.',
      resources: 'Ресурсы',
